...
Namespace WindowsApplication3
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class OrdersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Function AddOrdersRow(ByVal CustomerID As String, ByVal EmployeeID As Integer, ByVal RequiredDate As Date, ByVal ShipVia As Integer, ByVal Freight As Decimal) As OrdersRow
...
Namespace WindowsApplication3.nwindDataSetTableAdapters
	...
	Partial Public Class Order_DetailsTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_OrderID? As Integer, ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Decimal, ByVal Original_Quantity As Short) As Integer
		...
		Public Overridable Function Update(ByVal OrderID? As Integer, ByVal ProductID As Integer, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Original_OrderID? As Integer, ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Decimal, ByVal Original_Quantity As Short) As Integer
			...
			If (Original_OrderID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CInt(Original_OrderID.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(4).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(Original_ProductID))
			...
			Me.Adapter.UpdateCommand.Parameters(9).Value = (CShort(Original_Quantity))
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)>
		Public Overridable Function Update(ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Original_OrderID? As Integer, ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Decimal, ByVal Original_Quantity As Short) As Integer
	...
	Partial Public Class OrdersTableAdapter
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)>
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_EmployeeID? As Integer, ByVal Original_RequiredDate? As Global.System.DateTime, ByVal Original_ShipVia? As Integer, ByVal Original_Freight? As Decimal) As Integer
			...
			If (Original_ShipVia.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CInt(Original_ShipVia.Value))
			Else
		...
		Public Overridable Function Insert(ByVal CustomerID As String, ByVal EmployeeID? As Integer, ByVal RequiredDate? As Global.System.DateTime, ByVal ShipVia? As Integer, ByVal Freight? As Decimal) As Integer
			...
			If (ShipVia.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(3).Value = (CInt(ShipVia.Value))
			Else
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)>
		Public Overridable Function Update(ByVal CustomerID As String, ByVal EmployeeID? As Integer, ByVal RequiredDate? As Global.System.DateTime, ByVal ShipVia? As Integer, ByVal Freight? As Decimal, ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_EmployeeID? As Integer, ByVal Original_RequiredDate? As Global.System.DateTime, ByVal Original_ShipVia? As Integer, ByVal Original_Freight? As Decimal) As Integer
			If (CustomerID Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
			Else
			...
			End If
			If (ShipVia.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CInt(ShipVia.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(4).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(Original_OrderID))
			If (Original_CustomerID Is Nothing) Then
			...
			If (Original_EmployeeID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(8).Value = (DirectCast(0, Object))
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(Original_EmployeeID.Value))
			Else
			...
			If (Original_ShipVia.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CInt(Original_ShipVia.Value))
			Else
